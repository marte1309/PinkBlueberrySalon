  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-body font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-input bg-background shadow-soft hover:bg-accent hover:text-accent-foreground hover:shadow-gold",
        ...
        luxury: "bg-gradient-luxury text-primary-foreground shadow-luxury hover:shadow-gold hover:scale-105 animate-shimmer",
        ...
        hero: "bg-gradient-primary text-primary-foreground shadow-luxury hover:shadow-gold hover:scale-110 text-h3 px-8 py-6 animate-glow",
      },
      size: {
