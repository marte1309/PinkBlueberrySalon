...
exports.handler = async (event) => {
  try {
    ...
    if (!userPoolId || !clientId) {
      console.error('Environment variables USER_POOL_ID and USER_POOL_CLIENT_ID must be set');
    ...
    if (error.code === 'UsernameExistsException') {
      return formatResponse(409, { error: "A user with this email already exists" });
