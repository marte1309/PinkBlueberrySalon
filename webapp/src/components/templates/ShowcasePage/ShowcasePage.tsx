...
export const ShowcasePage: React.FC = () => {
  ...
  const exampleService = {
    ...
    description:
      "This is a demonstration of our enhanced service card with beautiful hover effects and animations.",
    duration: 90,
    price: 165,
    rating: 5.0,
    image:
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-h3 text-muted-foreground max-w-2xl mx-auto">
                Showcasing the new animation components for the Pink Blueberry
                project
              </p>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              {[
                { id: "logo", label: "Animated Logo", icon: CircleAlert },
                      ...
                      <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                        <div className="text-center p-4">
                          ...
                          <p className="text-muted-foreground">
                            The logo floats gently with a smooth animation that
                            adds subtle movement to the page.
                          </p>
                        </div>
                        <div className="text-center p-4">
                          <div className="mb-4">
                          ...
                          <p className="text-muted-foreground">
                            A subtle gradient glow animates behind the logo to
                    ...
                    <div className="text-center space-y-8">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                        <div className="text-center p-4">
                          ...
                          <p className="text-muted-foreground">
                            Buttons now have an elegant sweep animation that
                            creates a wave effect on hover.
                          </p>
                        </div>
                        <div className="text-center p-4">
                          <div className="mb-4">
                          ...
                          <p className="text-muted-foreground">
                            Enhanced scale transition provides a more premium
                            interactive feel.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 py-12">
                        <div className="flex flex-col items-center gap-4">
                          ...
                          <p className="text-muted-foreground text-small">
                            Brand-centric loading animation using the logo.
                          </p>
                        </div>
                        ...
                        <div className="flex flex-col items-center gap-4">
                          ...
                          <p className="text-muted-foreground text-small">
                            Elegant circular loading animation with brand
                            colors.
                          </p>
                        </div>
                        ...
                        <div className="flex flex-col items-center gap-4">
                          ...
                          <p className="text-muted-foreground text-small">
                            Subtle dots animation for inline loading states.
                          </p>
                        </div>
                      </div>

                      <div className="pt-8 border-t border-border">
                        <h4 className="text-h3 font-medium text-foreground mb-6">
                    ...
                    <div className="text-center space-y-8">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                        <div className="text-center p-4">
                          ...
                          <p className="text-muted-foreground">
                            Cards now feature an animated glowing border on
                            hover.
                          </p>
                        </div>
                        <div className="text-center p-4">
                          ...
                          <p className="text-muted-foreground">
                            Image zoom effect with subtle overlay creates a
                            premium interaction.
                          </p>
                        </div>
                      </div>
