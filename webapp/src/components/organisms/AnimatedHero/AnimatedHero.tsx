  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(40%_40%_at_0%_100%,hsla(var(--luxury-gold)/0.2)_0%,transparent_80%)] animate-pulse-glow" style={{ animationDelay: '1000ms' }}></div>
      </div>
      ...
      >
        <div className="max-w-5xl mx-auto space-y-12 pt-20">
          ...
          >
            ...
            <Link to="/services">
              <Button variant="watercolor" size="xl" className="min-w-[220px] group">
      ...
      >
        <div className="flex flex-col items-center gap-2">
          <span className="text-muted-foreground text-small">Discover More</span>
